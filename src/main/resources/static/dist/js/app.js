...
//确认模态对话框
function confirmModel(msg, confirmFunc) {
    $("#smModal .modal-body").empty().append("<p>"+msg+"</p>");
    $("#smModal .btn-confirm").unbind().click(confirmFunc);
    $("#smModal").modal({backdrop: 'static', keyboard: false});
}


//提示对话框
function alertModel(msg) {
    $("#lgModal .modal-body").empty().append("<p>"+msg+"</p>");
    $("#lgModal").modal({backdrop: 'static', keyboard: false});
}
