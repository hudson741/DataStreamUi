<div style="margin-bottom: 10px">
    ...
    <form method="post" action="stormTopoPub" enctype="multipart/form-data">
        <input type="file" name="file" class="form-control" placeholder="127.0.0.1:8080" ng-trim="true"
               maxlength="255" ng-model="stormURL" style="margin-bottom: 10px" />
        <input type="submit" type="button" class="btn btn-info" ng-click="setStormURL(stormURL.value)" style="margin-bottom: 10px"/>
    </form>
