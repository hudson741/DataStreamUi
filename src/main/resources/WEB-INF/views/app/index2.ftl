...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index.html" class="logo">
      ...
      <span class="logo-lg"><b>DATA_STREAM </b>LTE</span>
    </a>
      ...
      <ul class="sidebar-menu">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="pages/dashboard.html"><i class="fa fa-circle-o"></i> 面板 v1</a></li>
            <li class="active"><a href="index2.html"><i class="fa fa-circle-o"></i> 面板 v2</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="pages/layout/top-nav.html"><i class="fa fa-circle-o"></i>头部导航</a></li>
            <li><a href="pages/layout/boxed.html"><i class="fa fa-circle-o"></i>盒装布局</a></li>
            <li><a href="pages/layout/fixed.html"><i class="fa fa-circle-o"></i>固定导航</a></li>
            <li><a href="pages/layout/collapsed-sidebar.html"><i class="fa fa-circle-o"></i>隐藏侧栏</a></li>
            <li><a href="index.html"><i class="fa fa-circle-o"></i>非跳转模式</a></li>
          </ul>
        </li>
        <li>
          <a href="pages/widgets.html">
            <i class="fa fa-th"></i> <span>小组件</span>
            <span class="pull-right-container">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="pages/UI/timeline.html"><i class="fa fa-circle-o"></i> 时间</a></li>
            <li><a href="pages/UI/modals.html"><i class="fa fa-circle-o"></i> 提示</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="pages/forms/general.html"><i class="fa fa-circle-o"></i> 一般</a></li>
            <li><a href="pages/forms/advanced.html"><i class="fa fa-circle-o"></i> 高级</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="pages/tables/simple.html"><i class="fa fa-circle-o"></i> 普通表格</a></li>
