...
public class StormThriftService {
  ...
  public interface Iface {
    ...
    public void addDockerComponent(java.lang.String imageName, java.lang.String containerName, java.lang.String runIp, java.lang.String dockerIp, java.lang.String businessTag, java.lang.String priority, java.lang.String dockerArgs, java.lang.String netUrl, java.lang.String cm, java.util.Map<java.lang.String,java.lang.String> host, java.util.Map<java.lang.String,java.lang.String> port) throws org.apache.thrift.TException;
  ...
  public interface AsyncIface {
    ...
    public void addDockerComponent(java.lang.String imageName, java.lang.String containerName, java.lang.String runIp, java.lang.String dockerIp, java.lang.String businessTag, java.lang.String priority, java.lang.String dockerArgs, java.lang.String netUrl, java.lang.String cm, java.util.Map<java.lang.String,java.lang.String> host, java.util.Map<java.lang.String,java.lang.String> port, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void addDockerComponent(java.lang.String imageName, java.lang.String containerName, java.lang.String runIp, java.lang.String dockerIp, java.lang.String businessTag, java.lang.String priority, java.lang.String dockerArgs, java.lang.String netUrl, java.lang.String cm, java.util.Map<java.lang.String,java.lang.String> host, java.util.Map<java.lang.String,java.lang.String> port) throws org.apache.thrift.TException
    {
      send_addDockerComponent(imageName, containerName, runIp, dockerIp, businessTag, priority, dockerArgs, netUrl, cm, host, port);
      recv_addDockerComponent();
    }

    public void send_addDockerComponent(java.lang.String imageName, java.lang.String containerName, java.lang.String runIp, java.lang.String dockerIp, java.lang.String businessTag, java.lang.String priority, java.lang.String dockerArgs, java.lang.String netUrl, java.lang.String cm, java.util.Map<java.lang.String,java.lang.String> host, java.util.Map<java.lang.String,java.lang.String> port) throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void addDockerComponent(java.lang.String imageName, java.lang.String containerName, java.lang.String runIp, java.lang.String dockerIp, java.lang.String businessTag, java.lang.String priority, java.lang.String dockerArgs, java.lang.String netUrl, java.lang.String cm, java.util.Map<java.lang.String,java.lang.String> host, java.util.Map<java.lang.String,java.lang.String> port, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler) throws org.apache.thrift.TException {
      checkReady();
      addDockerComponent_call method_call = new addDockerComponent_call(imageName, containerName, runIp, dockerIp, businessTag, priority, dockerArgs, netUrl, cm, host, port, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }
    ...
    public static class addDockerComponent_call extends org.apache.thrift.async.TAsyncMethodCall<Void> {
      ...
      public addDockerComponent_call(java.lang.String imageName, java.lang.String containerName, java.lang.String runIp, java.lang.String dockerIp, java.lang.String businessTag, java.lang.String priority, java.lang.String dockerArgs, java.lang.String netUrl, java.lang.String cm, java.util.Map<java.lang.String,java.lang.String> host, java.util.Map<java.lang.String,java.lang.String> port, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class addDockerComponent<I extends Iface> extends org.apache.thrift.ProcessFunction<I, addDockerComponent_args> {
      ...
      public addDockerComponent_result getResult(I iface, addDockerComponent_args args) throws org.apache.thrift.TException {
        addDockerComponent_result result = new addDockerComponent_result();
        iface.addDockerComponent(args.imageName, args.containerName, args.runIp, args.dockerIp, args.businessTag, args.priority, args.dockerArgs, args.netUrl, args.cm, args.host, args.port);
        return result;
      }
    }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class addDockerComponent<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, addDockerComponent_args, Void> {
      ...
      public void start(I iface, addDockerComponent_args args, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler) throws org.apache.thrift.TException {
        iface.addDockerComponent(args.imageName, args.containerName, args.runIp, args.dockerIp, args.businessTag, args.priority, args.dockerArgs, args.netUrl, args.cm, args.host, args.port,resultHandler);
      }
    }
  ...
  public static class addDockerComponent_args implements org.apache.thrift.TBase<addDockerComponent_args, addDockerComponent_args._Fields>, java.io.Serializable, Cloneable, Comparable<addDockerComponent_args>   {
    ...
    private static final org.apache.thrift.protocol.TField HOST_FIELD_DESC = new org.apache.thrift.protocol.TField("host", org.apache.thrift.protocol.TType.MAP, (short)10);
    private static final org.apache.thrift.protocol.TField PORT_FIELD_DESC = new org.apache.thrift.protocol.TField("port", org.apache.thrift.protocol.TType.MAP, (short)11);
